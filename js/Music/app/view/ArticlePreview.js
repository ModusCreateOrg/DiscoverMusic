    ...
    config: {
        ...
        tpl: [
            '<div class="music-article-image" style="background-image:url(http://src.sencha.io/1024/{image});">',
                '<div class="music-article-category {[values.category.toLowerCase()]}"><h1>{category}</h1></div>',
                '<div class="music-article-title"><div class="music-content-all">',
                    ...
                    '<div class="music-article-title-content">',
                        '<div class="music-article-read-btn {[values.category.toLowerCase()]}">Read <em>&</em> Listen</div>',
                        '<h2>{title}</h2>',
                    '</div></div>',
                '</div>',
            '</div>'
